...
const REQUIRED_TEMPLATE_TAGS = {
  empty: ["official", "premium", "sandbox", "garden"],
  obby: ["official", "premium", "obby", "checkpoint"],
  coin: ["official", "premium", "collect", "exploration"],
  door: ["official", "premium", "puzzle", "button"],
  checkpoint: ["official", "platform", "checkpoint"],
  mechanics: ["official", "premium", "tutorial", "mechanics"],
  combatArena: ["official", "premium", "combat", "enemy"],
  combatDungeon: ["official", "premium", "combat", "dungeon"],
  guideMission: ["official", "premium", "objective", "npc"],
  localTeamArena: ["official", "premium", "team", "combat"],
  localCapturePoint: ["official", "premium", "capture", "team"],
  multiplayerPvpArena: ["official", "premium", "multiplayer", "pvp"],
  multiplayerCoopEnemies: ["official", "premium", "multiplayer", "coop"],
  weaponArsenal: ["official", "premium", "tycoon", "factory"],
  pvpArsenal: ["official", "premium", "multiplayer", "weapons"],
  competitiveCoin: ["official", "premium", "tycoon", "economy"],
  objectiveArena: ["official", "premium", "tycoon", "energy"],
  keyPuzzle: ["official", "premium", "puzzle", "keys"],
  logic: ["official", "premium", "mechanics", "logic"],
  forest: ["official", "premium", "forest", "exploration"],
  desert: ["official", "premium", "desert", "platform"],
  neonObby: ["official", "premium", "obby", "neon"],
  megaObby: ["official", "premium", "showcase", "obby"],
  megaCoinWorld: ["official", "premium", "islands", "collect"],
  keyDungeon: ["official", "premium", "castle", "keys"],
  testCity: ["official", "premium", "city", "showcase"],
  adventureIsland: ["official", "premium", "pirate", "island"],
  basicTycoon: ["official", "premium", "tycoon", "economy"],
  stressTest: ["official", "premium", "stress", "performance"],
};
